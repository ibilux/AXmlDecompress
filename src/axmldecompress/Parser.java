...
public class Parser {
            ...
            switch (tag0) {
                case START_TAG: {
                    ...
                    for (int ii = 0; ii < numbAttrs; ii++) {
                        ...
                        //String attrValue = compXmlString(xml, sitOff, stOff, attrValueSi);
                        String attrValue = attrValueSi != -1 ? compXmlString(xml, sitOff, stOff, attrValueSi) : Integer.toString(attrResId);
                ...
                case END_DOC_TAG:
                    ...
                    break OUTER;
                default:
                    //System.err.print("  Unrecognized tag code '" + Integer.toHexString(tag0) + "' at offset " + off);
                    break OUTER;
            }
        }
    ...
    public static void prtIndent(int indent, String str) {
        //System.err.print(spaces.substring(0, Math.min(indent * 2, spaces.length())) + str);
    }
